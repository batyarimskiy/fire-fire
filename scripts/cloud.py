...
try:
    ...
    print('requests не найден! Установите его : pip3 install requests')
    install = input('Хотите чтобы я установил за вас ? Y или N >> ')
...
try:
    ...
    print('subprocess не найден! Установите его : pip3 install subprocess')
    install = input('Хотите чтобы я установил за вас ? Y или N >> ')
    if install=="Y" or install=='y':
        os.system('sudo apt-get install python3-pip')
...
try:
    ...
    print('re не найден! Установите его : pip3 install re')
    install = input('Хотите чтобы я установил за вас ? Y или N >> ')
    if install=="Y" or install=='y':
        os.system('sudo apt-get install python3-pip')
...
try:
    ...
    print('multiprocessing не найден! Установите его : pip3 install multiprocessing')
    install = input('Хотите чтобы я установил за вас ? Y или N >> ')
    if install=="Y" or install=='y':
        os.system('sudo apt-get install python3-pip')
...
def checker(domain):
    ...
    try:
        ...
        if link.status_code ==200 or link.status_code==403:
            ...
            print('\x1b[1;32;40m'+'[+] домен : '+domain+' IP-адрес : '+filtered_re[0]+ '\033[0m')

        else:

            print('\x1b[0;31;40m'+'[-] домен : '+domain+' IP-адрес : N/A '+ '\033[0m')
    except Exception:
        print('\x1b[0;31;40m'+'[-] домен : '+domain+' IP-адрес : N/A '+ '\033[0m')
        pass
